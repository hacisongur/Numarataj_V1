...
namespace Numarataj.WebUI.Areas.Admin.Controllers
{
    ...
    public class AdresTespitController : Controller
    {
        ...
        //public async Task<IActionResult> GeneratePdf(int id, string title, string pdfName, bool isTcHidden = false)
        //{
        //    var values = await _context.AdresTespit.FirstOrDefaultAsync(x => x.BelgeNoId == id);
        //    var adresTespitResponse = _mapper.Map<ResultAdresTespitDto>(values);
